...
const $RefParser = require('trieve-json-schema-ref-parser');
const dereference = require('trieve-json-schema-ref-parser/lib/dereference');
const normalizeArgs = require('trieve-json-schema-ref-parser/lib/normalize-args');
